...
alias ktm-report='cdupngo && cd tools/ktm-error-auto && DB_USER=swebber DB_PASS=***REMOVED*** ALOHA_AUTH=***REMOVED*** npx ts-node index.ts'
alias order-snapshot='cdupngo && cd tools/pull-json-api-order && DB_USER=swebber DB_PASS=***REMOVED*** npx ts-node index.ts'
alias dev-order-snapshot='cdupngo && cd tools/pull-json-api-order && DB_ENV=dev DB_USER=dev DB_PASS=***REMOVED*** npx ts-node index.ts'
