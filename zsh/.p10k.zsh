# Output all colors for reference when sourced
#for i in {0..255}; do print -Pn "%K{$i}  %k%F{$i}${(l:3::0:)i}%f " ${${(M)$((i%6)):#3}:+$'\n'}; done
#
# Generated by Powerlevel10k configuration wizard on 2024-04-25 at 08:23 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_PHP_FOREGROUND=12
  ...
  typeset -g POWERLEVEL9K_VIM_SHELL_FOREGROUND=6
  # Custom icon.
